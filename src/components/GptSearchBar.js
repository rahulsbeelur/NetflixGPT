...
const GptSearchBar = () => {
    ...
    return (
        <div className="pt-[10%] w-screen h-screen ">
            <form className="w-1/2 grid grid-cols-12 mx-auto" onSubmit={(e) => e.preventDefault()}>
                <input
                    type="text"
                ...
                <button
                    ...
                    className="m-4 col-span-3 bg-red-700 hover:bg-red-900 text-white rounded border border-black">
                    Suggest
                </button>
            </form>
            <GptMovieSuggestions />
